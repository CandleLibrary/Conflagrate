...
(env, sym, pos) => ((({ emptyProp }, flag, rules, alt_rules, index, NOT) => (state) => ((+NOT) ^ +(!emptyProp(state, flag, index))) ? rules.map(r => r(state)).join("") : alt_rules.map(r => r(state)).join(""))(env, sym[2], sym[5], sym[7] || [], sym[3], !!sym[1])) /*3*/,
(env, sym, pos) => ((({ emptyProp }, flag, rules, alt_rules, index, NOT) => (state) => ((+NOT) ^ +(!emptyProp(state, flag, index))) ? rules.map(r => r(state)).join("") : alt_rules.map(r => r(state)).join(""))(env, sym[2], sym[4], sym[6] || [], !!sym[1])) /*4*/,
(env, sym, pos) => ((({ emptyProp }, flag, rules, alt_rules, index, NOT) => (state) => ((+NOT) ^ +(!emptyProp(state, flag, index))) ? rules.map(r => r(state)).join("") : alt_rules.map(r => r(state)).join(""))(env, sym[2], sym[5], null || [], sym[3], !!sym[1])) /*5*/,
(env, sym, pos) => ((({ emptyProp }, flag, rules, alt_rules, index, NOT) => (state) => ((+NOT) ^ +(!emptyProp(state, flag, index))) ? rules.map(r => r(state)).join("") : alt_rules.map(r => r(state)).join(""))(env, sym[2], sym[4], null || [], !!sym[1])) /*6*/,
(env, sym, pos) => ((({ emptyProp }, flag, rules, alt_rules, index, NOT) => (state) => ((+NOT) ^ +(!emptyProp(state, flag, index))) ? rules.map(r => r(state)).join("") : alt_rules.map(r => r(state)).join(""))(env, sym[1], sym[4], sym[6] || [], sym[2], !!null)) /*7*/,
(env, sym, pos) => ((({ emptyProp }, flag, rules, alt_rules, index, NOT) => (state) => ((+NOT) ^ +(!emptyProp(state, flag, index))) ? rules.map(r => r(state)).join("") : alt_rules.map(r => r(state)).join(""))(env, sym[1], sym[3], sym[5] || [], !!null)) /*8*/,
(env, sym, pos) => ((({ emptyProp }, flag, rules, alt_rules, index, NOT) => (state) => ((+NOT) ^ +(!emptyProp(state, flag, index))) ? rules.map(r => r(state)).join("") : alt_rules.map(r => r(state)).join(""))(env, sym[1], sym[4], null || [], sym[2], !!null)) /*9*/,
(env, sym, pos) => ((({ emptyProp }, flag, rules, alt_rules, index, NOT) => (state) => ((+NOT) ^ +(!emptyProp(state, flag, index))) ? rules.map(r => r(state)).join("") : alt_rules.map(r => r(state)).join(""))(env, sym[1], sym[3], null || [], !!null)) /*10*/,
